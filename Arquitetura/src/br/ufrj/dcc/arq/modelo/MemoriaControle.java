...
public class MemoriaControle {
	...
	public static final short RYMENOSR0[] 					= cria_Vetor(NULOV, Multiplex4E.PASSAR0, Multiplex5E.PASSARY, Ula.SUBBA, Uc.I, Uc.C, NULO);
	public static final short R2MENOSR0[]		 			= cria_Vetor(NULOV, Multiplex4E.PASSAR0, Multiplex5E.PASSAR2, Ula.SUBBA, Uc.E, Uc.C, NULO);
	public static final short R3MENOSR0[] 					= cria_Vetor(NULOV, Multiplex4E.PASSAR0, Multiplex5E.PASSAR3, Ula.SUBBA, Uc.F, Uc.C, NULO);
	public static final short R4MENOSR0[] 					= cria_Vetor(NULOV, Multiplex4E.PASSAR0, Multiplex5E.PASSAR4, Ula.SUBBA, Uc.G, Uc.C, NULO);
	public static final short RYMENOSR1[] 					= cria_Vetor(NULOV, Multiplex4E.PASSAR1, Multiplex5E.PASSARY, Ula.SUBBA, Uc.I, Uc.D, NULO);
	public static final short R2MENOSR1[] 					= cria_Vetor(NULOV, Multiplex4E.PASSAR1, Multiplex5E.PASSAR2, Ula.SUBBA, Uc.E, Uc.D, NULO);
	public static final short R3MENOSR1[] 					= cria_Vetor(NULOV, Multiplex4E.PASSAR1, Multiplex5E.PASSAR3, Ula.SUBBA, Uc.F, Uc.D, NULO);
	public static final short R4MENOSR1[] 					= cria_Vetor(NULOV, Multiplex4E.PASSAR1, Multiplex5E.PASSAR4, Ula.SUBBA, Uc.G, Uc.D, NULO);
	public static final short RDADOSMENOSR2[]		 		= cria_Vetor(NULOV, Multiplex4E.PASSARDADOS, Multiplex5E.PASSAR2, Ula.SUBAB, Uc.B, Uc.E, NULO);
	public static final short RXMENOSR2[] 					= cria_Vetor(NULOV, Multiplex4E.PASSARX, Multiplex5E.PASSAR2, Ula.SUBAB, Uc.H, Uc.E, NULO);
	public static final short R0MENOSR2[]					= cria_Vetor(NULOV, Multiplex4E.PASSAR0, Multiplex5E.PASSAR2, Ula.SUBAB, Uc.C, Uc.E, NULO);
	public static final short R1MENOSR2[] 					= cria_Vetor(NULOV, Multiplex4E.PASSAR1, Multiplex5E.PASSAR2, Ula.SUBAB, Uc.D, Uc.E, NULO);
	public static final short RDADOSMENOSR3[]		 		= cria_Vetor(NULOV, Multiplex4E.PASSARDADOS, Multiplex5E.PASSAR3, Ula.SUBAB, Uc.B, Uc.F, NULO);
	public static final short RXMENOSR3[] 					= cria_Vetor(NULOV, Multiplex4E.PASSARX, Multiplex5E.PASSAR3, Ula.SUBAB, Uc.H, Uc.F, NULO);
	public static final short R0MENOSR3[] 					= cria_Vetor(NULOV, Multiplex4E.PASSAR0, Multiplex5E.PASSAR3, Ula.SUBAB, Uc.C, Uc.F, NULO);
	public static final short R1MENOSR3[] 					= cria_Vetor(NULOV, Multiplex4E.PASSAR1, Multiplex5E.PASSAR3, Ula.SUBAB, Uc.D, Uc.F, NULO);
	public static final short RDADOSMENOSR4[]		 		= cria_Vetor(NULOV, Multiplex4E.PASSARDADOS, Multiplex5E.PASSAR4, Ula.SUBAB, Uc.B, Uc.G, NULO);
	public static final short RXMENOSR4[] 					= cria_Vetor(NULOV, Multiplex4E.PASSARX, Multiplex5E.PASSAR4, Ula.SUBAB, Uc.H, Uc.G, NULO);
	public static final short R0MENOSR4[] 					= cria_Vetor(NULOV, Multiplex4E.PASSAR0, Multiplex5E.PASSAR4, Ula.SUBAB, Uc.C, Uc.G, NULO);
	public static final short R1MENOSR4[] 					= cria_Vetor(NULOV, Multiplex4E.PASSAR1, Multiplex5E.PASSAR4, Ula.SUBAB, Uc.D, Uc.G, NULO);
	...
	public static final short R0MENOSRY[] 					= cria_Vetor(NULOV, Multiplex4E.PASSAR0, Multiplex5E.PASSARY, Ula.SUBAB, Uc.C, Uc.I, NULO);
	public static final short R1MENOSRY[] 					= cria_Vetor(NULOV, Multiplex4E.PASSAR1, Multiplex5E.PASSARY, Ula.SUBAB, Uc.D, Uc.I, NULO);
	public static final short R2MENOSRX[] 					= cria_Vetor(NULOV, Multiplex4E.PASSARX, Multiplex5E.PASSAR2, Ula.SUBBA, Uc.E, Uc.H, NULO);
	public static final short R3MENOSRX[] 					= cria_Vetor(NULOV, Multiplex4E.PASSARX, Multiplex5E.PASSAR3, Ula.SUBBA, Uc.F, Uc.H, NULO);
	public static final short R4MENOSRX[] 					= cria_Vetor(NULOV, Multiplex4E.PASSARX, Multiplex5E.PASSAR4, Ula.SUBBA, Uc.G, Uc.H, NULO);
